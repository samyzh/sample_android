 ...
 */
public class GridViewActivity extends BaseSampleActivity implements OnRefreshListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_a01ui_a27refresh_acitionbarptr_gridview);
		...
		ActionBarPullToRefresh.from(this).options(Options.create()
		// Here we make the refresh scroll distance to 75% of the GridView height
				...
				.headerLayout(R.layout.view_a01ui_a27refresh_acitionbarptr_header)
				// Here we define a custom header transformer which will alter the header
				// based on the current pull-to-refresh state
				.headerTransformer(new CustomisedHeaderTransformer()).build()).allChildrenArePullable().listener(this)
		// Here we'll set a custom ViewDelegate
				.useViewDelegate(GridView.class, new AbsListViewDelegate()).setup(mPullToRefreshLayout);
	}
