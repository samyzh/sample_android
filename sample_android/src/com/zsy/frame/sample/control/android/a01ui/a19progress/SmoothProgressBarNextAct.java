 ...
 */
public class SmoothProgressBarNextAct extends BaseAct {
...
/*	SmoothProgressBarNextAct() {
	...
	private void updateValues() {
		...
		CircularProgressDrawable.Builder b = new CircularProgressDrawable.Builder(this).colors(getResources().getIntArray(R.array.gplus_colors)).sweepSpeed(mSpeed).rotationSpeed(mSpeed).strokeWidth(dpToPx(mStrokeWidth)).style(CircularProgressDrawable.Style.ROUNDED);
	...
	public void setRootView() {
		setContentView(R.layout.activity_a01ui_a19progress_smoothprogressbar_next);
	}
}
