...
public class FragmentTabsActivity extends BaseSampleActivity implements ActionBar.TabListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_a01ui_a27refresh_acitionbarptr_fragment_tabs);
	 ...
	 * Fragment Class
	 */
	public static class SampleFragment extends Fragment implements OnRefreshListener {
		private PullToRefreshLayout mPullToRefreshLayout;

		@Override
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			// Inflate the layout
			View view = inflater.inflate(R.layout.fragment_a01ui_a27refresh_acitionbarptr_tabs, container, false);
