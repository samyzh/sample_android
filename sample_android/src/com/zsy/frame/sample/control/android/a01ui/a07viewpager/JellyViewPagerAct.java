...
import com.zsy.frame.sample.control.android.a01ui.a07viewpager.widget.JellyViewPager;

public class JellyViewPagerAct extends FragmentActivity {
	JellyViewPager pager;
	int currentItem;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_a01ui_a07viewpager_jellyviewpager);
