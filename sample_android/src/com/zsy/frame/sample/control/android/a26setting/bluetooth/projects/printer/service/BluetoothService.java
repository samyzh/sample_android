package com.zsy.frame.sample.control.android.a26setting.bluetooth.projects.printer.service;
...
public class BluetoothService {
	...
	public BluetoothService(Context context, ListView unbondDevicesListView, ListView bondDevicesListView, Button switchBT, Button searchDevices) {
	...
	private void addUnbondDevicesToListView() {
		...
		SimpleAdapter simpleAdapter = new SimpleAdapter(this.context, data, R.layout.item_a26setting_bluetooth_projects_printer_unbonddevice, from, to);
		// 把适配器装载到listView中
		...
		this.unbondDevicesListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				try {
					...
					ClsUtils.createBond(unbondDevices.get(arg2).getClass(), unbondDevices.get(arg2));
	...
	private void addBondDevicesToListView() {
		...
		SimpleAdapter simpleAdapter = new SimpleAdapter(this.context, data, R.layout.item_a26setting_bluetooth_projects_printer_bonddevice, from, to);
		// 把适配器装载到listView中
		...
		this.bondDevicesListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				intent.setClassName(context, "com.zsy.frame.sample.control.android.a26setting.bluetooth.projects.printer.PrintDataAct");
