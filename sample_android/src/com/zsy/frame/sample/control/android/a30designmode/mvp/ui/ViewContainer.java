...
public class ViewContainer {
    ...
    public ViewContainer(Context mContext, int layout) {
        ...
        setNonetView(R.layout.view_a30designmode_mvp_container_container_nonet);
        setErrorView(R.layout.view_a30designmode_mvp_container_container_error);
        setEmptyView(R.layout.view_a30designmode_mvp_container_container_empty);
        setLoadingView(R.layout.view_a30designmode_mvp_container_container_loading);
    }
