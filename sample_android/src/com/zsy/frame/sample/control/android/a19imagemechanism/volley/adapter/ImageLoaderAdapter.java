...
import com.zsy.frame.lib.net.http.volley.toolbox.ImageLoader.ImageContainer;
...
public class ImageLoaderAdapter extends ImageBaseAdapter {
	...
	void setImage(ImageView imageView, String imageUrl) {
		...
		ImageListener listener = ImageLoader.getImageListener(imageView, R.drawable.a19imagemechanism_volley_ic_empty, R.drawable.a19imagemechanism_volley_ic_empty);
