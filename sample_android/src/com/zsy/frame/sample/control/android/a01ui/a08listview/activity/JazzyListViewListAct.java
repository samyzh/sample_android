...
public class JazzyListViewListAct extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_a01ui_a08listview_jazzylist_listview);
		mList = (JazzyListView) findViewById(android.R.id.list);
		mList.setAdapter(new ListAdapter(this, R.layout.item_a01ui_a08listview_jazzylist_listview));
