...
public class BluetoothTools {
	...
	/**
	 * 本程序所使用的UUID;属于手机蓝牙各类服务对应的UUID（常用的几个已通过验证这个待测试验证）
	 * About UUID
	 ...
	 * 要连接的蓝牙地址
	 */
	public static final String BluetoothAddress = "22:22:49:C0:B9:0F";// 作为服务端的地址
	/**
	 * 要连接的蓝牙地址2
	 */
	public static final String BluetoothAddress2 = "38:BC:1A:15:2A:02";// 作为客户端的地址
}
