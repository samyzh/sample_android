...
public class MaterialDesignMainAct extends Activity implements OnColorSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_a01ui_a24materialdesign_materialdesign_main);
		...
		buttonSelectColor.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				ColorSelector colorSelector = new ColorSelector(MaterialDesignMainAct.this, backgroundColor, MaterialDesignMainAct.this);
				colorSelector.show();
			}
		});
		...
		layoutRipple.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(MaterialDesignMainAct.this, MaterialDesignButtonsAct.class);
		...
		layoutRipple.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(MaterialDesignMainAct.this, MaterialDesignSwitchAct.class);
				intent.putExtra("BACKGROUND", backgroundColor);
				startActivity(intent);
			}
		});
		...
		layoutRipple.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(MaterialDesignMainAct.this, MaterialDesignProgressAct.class);
				intent.putExtra("BACKGROUND", backgroundColor);
				startActivity(intent);
			}
		});
		...
		layoutRipple.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(MaterialDesignMainAct.this, MaterialDesignWidgetAct.class);
				intent.putExtra("BACKGROUND", backgroundColor);
				startActivity(intent);
			}
		});
