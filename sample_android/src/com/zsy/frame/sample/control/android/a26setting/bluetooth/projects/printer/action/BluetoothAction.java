package com.zsy.frame.sample.control.android.a26setting.bluetooth.projects.printer.action;
...
import com.zsy.frame.sample.control.android.a26setting.bluetooth.projects.printer.service.BluetoothService;
...
public class BluetoothAction implements OnClickListener {
	...
	public BluetoothAction(Context context, ListView unbondDevices, ListView bondDevices, Button switchBT, Button searchDevices, Activity activity) {
		super();
	...
	/**
	 * @description：开始查询蓝牙设备
	 * @author samy
	 * @date 2015-3-27 下午10:47:06
	 */
