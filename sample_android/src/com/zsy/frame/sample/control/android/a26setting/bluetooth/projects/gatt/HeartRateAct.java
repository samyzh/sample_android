...
/** 心脉率监检测
 * @description：this activity's purpose is to show how to use particular type of devices in easy and fast way
 * @author samy
 * @date 2015-2-23 下午8:09:48
 */
public class HeartRateAct extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_a26setting_bluetooth_gatt_heart_rate);
		mConsole = (EditText) findViewById(R.id.hr_console_item);
		log("Creating activity");

		// Show the Up button in the action bar.
		getActionBar().setDisplayHomeAsUpEnabled(true);
		setTitle("Heart Rate Test");
		mConsole = (EditText) findViewById(R.id.hr_console_item);
	...
	private BluetoothAdapter.LeScanCallback mDeviceFoundCallback = new BluetoothAdapter.LeScanCallback() {
		...
		public void onLeScan(final BluetoothDevice device, final int rssi, final byte[] scanRecord) {
			...
			HeartRateAct.this.mBTDevice = device;
