...
public class WeixinPay implements Serializable {
	...
	public String toString() {
		return "WeixinPay [orderNo=" + orderNo + ", appid=" + appid + ", partnerid=" + partnerid + ", prepayid=" + prepayid + ", wxpackage=" + wxPackage + ", noncestr=" + noncestr + ", timestamp=" + timestamp + ", sign=" + sign + "]";
	}
