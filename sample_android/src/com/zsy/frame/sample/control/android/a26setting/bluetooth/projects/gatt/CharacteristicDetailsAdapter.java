...
public class CharacteristicDetailsAdapter extends BaseAdapter {
	...
	public CharacteristicDetailsAdapter(PeripheralAct parent, BleWrapper ble) {
		super();
		mBleWrapper = ble;
	...
	public View getView(int position, View convertView, ViewGroup p) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.item_a26setting_bluetooth_gatt_peripheral_details_characteristic, null);
