...
public class TestFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.fragment_a01ui_a07viewpager_jellyviewpager, container, false);
		initUI(rootView);
		return rootView;
	}
	...
	private void initUI(View root){
		...
		int res = bundle.getInt(Constant.KEY, R.drawable.a01ui_a07viewpager_jellyviewpager_a);
