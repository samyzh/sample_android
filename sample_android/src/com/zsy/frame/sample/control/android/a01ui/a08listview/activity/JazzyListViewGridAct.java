...
public class JazzyListViewGridAct extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_a01ui_a08listview_jazzylist_grid);
		mGrid = (JazzyGridView) findViewById(android.R.id.list);
		mGrid.setAdapter(new ListAdapter(this, R.layout.item_a01ui_a08listview_jazzylist_grid));
