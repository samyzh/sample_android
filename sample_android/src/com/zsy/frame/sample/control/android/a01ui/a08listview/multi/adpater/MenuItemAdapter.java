package com.zsy.frame.sample.control.android.a01ui.a08listview.multi.adpater;
...
/**
 * @description： 菜单列表List适配器
 * @author samy
 * @date 2014年9月10日 下午9:42:22
 */
public class MenuItemAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		TextView view;
		if (convertView == null) {
			view = (TextView) LayoutInflater.from(mContext).inflate(R.layout.item_a01ui_a08listview_multi_choose, parent, false);
		}
		else {
		...
		if (selectedText != null && selectedText.equals(mString)) {
			...
			view.setBackgroundDrawable(mContext.getResources().getDrawable(normalDrawbleId));// 设置未中状态背景图
		}
