...
public class Result {
	...
	public static String getNewOrderInfo(String out_trade_no, String subject, String total_fee) {
		...
		sb.append(total_fee);
		sb.append("\"&notify_url=\"");// 网址需要做URL编码; 异步通知;服务器异步通知页面路径，url待定；
