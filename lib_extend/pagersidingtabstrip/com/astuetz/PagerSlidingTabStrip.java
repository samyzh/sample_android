...
/**另外加的参数*/
	...
	private int tabBackgroundResId = R.drawable.pagersidingtabstrip_background_tab;
...
//			add
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (!shouldExpand || MeasureSpec.getMode(widthMeasureSpec) == MeasureSpec.UNSPECIFIED) { return; }
