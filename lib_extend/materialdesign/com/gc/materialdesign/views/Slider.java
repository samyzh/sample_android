...
public class Slider extends CustomView {
	...
	public void setValue(final int value) {
		if (placedBall == false) post(new Runnable() {
	...
	class Ball extends View {
		...
		public Ball(Context context) {
			super(context);
			setBackgroundResource(R.drawable.materialdesign_background_switch_ball_uncheck);
		}

		public void changeBackground() {
			if (value != min) {
				setBackgroundResource(R.drawable.materialdesign_background_checkbox);
	...
	class NumberIndicator extends Dialog {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			setContentView(R.layout.materialdesign_number_indicator_spinner);
	...
	class Indicator extends RelativeLayout {
		...
		protected void onDraw(Canvas canvas) {
			...
			if (animate && size >= finalSize) animate = false;
			if (animate == false) {
