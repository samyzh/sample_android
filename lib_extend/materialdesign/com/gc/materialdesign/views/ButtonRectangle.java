...
public class ButtonRectangle extends Button {
	...
	protected void setDefaultProperties() {
		...
		super.minWidth = 80;
		super.minHeight = 36;
		super.background = R.drawable.materialdesign_background_button_rectangle;
	...
	protected void setAttributes(AttributeSet attrs) {
		...
		rippleSpeed = attrs.getAttributeFloatValue(MATERIALDESIGNXML, "rippleSpeed", Utils.dpToPx(6, getResources()));
	}
