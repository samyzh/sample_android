...
public class ColorSelector extends android.app.Dialog implements OnValueChangedListener {
	...
	public ColorSelector(Context context, Integer color, OnColorSelectedListener onColorSelectedListener) {
		...
		setOnDismissListener(new OnDismissListener() {
			...
			public void onDismiss(DialogInterface dialog) {
				if (ColorSelector.this.onColorSelectedListener != null) ColorSelector.this.onColorSelectedListener.onColorSelected(ColorSelector.this.color);
			}
		});
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.materialdesign_color_selector);
	...
	public void show() {
		super.show();
		view.startAnimation(AnimationUtils.loadAnimation(context, R.anim.materialdesign_dialog_main_show_amination));
		backView.startAnimation(AnimationUtils.loadAnimation(context, R.anim.materialdesign_dialog_root_show_amin));
	}
	...
	@Override
	public void dismiss() {
		Animation anim = AnimationUtils.loadAnimation(context, R.anim.materialdesign_dialog_main_hide_amination);
		...
		Animation backAnim = AnimationUtils.loadAnimation(context, R.anim.materialdesign_dialog_root_hide_amin);
