...
public class FollowListPage extends FollowerListFakeActivity implements OnClickListener, OnItemClickListener {
	...
	public void onCreate() {
		...
		FrameLayout.LayoutParams lpSd = new FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
	...
	private static class FollowAdapter extends PullToRefreshListAdapter implements PlatformActionListener, Callback {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				LinearLayout.LayoutParams lpCheck = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
	...
	private static class PRTHeader extends LinearLayout {
		...
		public PRTHeader(Context context) {
			...
			LinearLayout.LayoutParams lpInner = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
