...
public class EditPageFakeActivity extends FakeActivity {
	...
	protected boolean isShowAtUserLayout(String platformName) {
		return "SinaWeibo".equals(platformName) || "TencentWeibo".equals(platformName) || "Facebook".equals(platformName) || "Twitter".equals(platformName) || "FacebookMessenger".equals(platformName);
	}
	...
	protected boolean initImageList(ImageListResultsCallback callback) {
		...
		if (shareImageList.size() == 0) { return false; }
